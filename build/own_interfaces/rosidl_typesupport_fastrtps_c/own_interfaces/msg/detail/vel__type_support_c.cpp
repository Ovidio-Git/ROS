...
#include "own_interfaces/msg/detail/vel__rosidl_typesupport_fastrtps_c.h"
...
using _Vel__ros_msg_type = own_interfaces__msg__Vel;
...
size_t get_serialized_size_own_interfaces__msg__Vel(
  const void * untyped_ros_message,
...
static uint32_t _Vel__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_own_interfaces__msg__Vel(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_own_interfaces
size_t max_serialized_size_own_interfaces__msg__Vel(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_own_interfaces__msg__Vel(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, own_interfaces, msg, Vel)() {
