...
bool own_interfaces__msg__vel__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("own_interfaces.msg._vel.Vel", full_classname_dest, 27) == 0);
  }
  own_interfaces__msg__Vel * ros_message = _ros_message;
  {  // vel
...
PyObject * own_interfaces__msg__vel__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("own_interfaces.msg._vel");
