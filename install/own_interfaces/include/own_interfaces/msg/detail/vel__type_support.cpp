...
{
  new (message_memory) own_interfaces::msg::Vel(_init);
}

void Vel_fini_function(void * message_memory)
{
  auto typed_message = static_cast<own_interfaces::msg::Vel *>(message_memory);
  typed_message->~Vel();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Vel_message_member_array[1] = {
  {
    ...
    offsetof(own_interfaces::msg::Vel, vel),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Vel_message_members = {
  "own_interfaces::msg",  // message namespace
  "Vel",  // message name
  1,  // number of fields
  sizeof(own_interfaces::msg::Vel),
...
{
  return &::own_interfaces::msg::rosidl_typesupport_introspection_cpp::Vel_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, own_interfaces, msg, Vel)() {
  return &::own_interfaces::msg::rosidl_typesupport_introspection_cpp::Vel_message_type_support_handle;
}
